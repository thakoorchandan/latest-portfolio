...
function SkillsComponent() {
  ...
  const technicalSkills = [
    // JavaScript, Typescript, Python, HTML, CSS, React, React Native, Node.js, Jest, Sequelize, Express
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-6xl flex justify-center flex-wrap sm:flex-nowrap sm:justify-normal">
